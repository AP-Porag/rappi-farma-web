<template>
  <div>
    <div class="ms__review--part ic-section-space">
      <div class="container">
        <div class="row">
          <div class="col-lg-7">
            <div class="ms__review--user ms__card">
              <div class="d-flex">
          ...
          <div class="col-lg-5">
            <div class="checkout-cart ms__card">
              <div class="ic__shopping--top">
                <ul class="ms__pick">
                  <li>
                    <div class="ms__pickup--point">
                      <h6>Pick-up-point</h6>
                      <p>Mainuddin Sani</p>
                      <p>Address</p>
                      <p>5612132123123132132132</p>
                    </div>
                  </li>
                  <li>
                    <div class="ms__pickup--point">
