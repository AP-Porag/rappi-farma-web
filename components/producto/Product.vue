    ...
    <div>
        <div class="ms__bestDeal--items">
            ...
            <div class="ms__bestDeal--img ms__beatuy--img">
                ...
                <img class="img" :data-src="product.image" alt="" v-lazy-load>
                </nuxt-link>
            </div>
            <div class="ms__bestDeal--information">
                <NuxtLink :to="product.path"><h6 class="title">{{product.title}}</h6></NuxtLink>
                <NuxtLink :to="product.path"><p class="discription">{{product.subtitle}}</p></NuxtLink>
            ...
            <nuxt-link :to="product.path" class="btn btn-primary btn-md w-100">Add</nuxt-link>
            </div>
        </div>
    </div>
  </template>
